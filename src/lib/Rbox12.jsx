...
const Rbox12 = forwardRef(({ children, style, color = [], backgroundColor = 'transparent' }, ref) => {
    ...
    return (
        ...
        `
            ...
            <div className="box12" style={style} ref={domRef}>
                {width ?
                    <>
                        <svg className="dev-border" width={width} height={height}>
                            ...
                            <polygon fill={backgroundColor} stroke={mergedColor[1]} strokeWidth="1" filter="url(#fiterBorder12)"
                                points={`0, 0 ${width}, 0 ${width}, ${height} 0, ${height} 0, 0`} />
                            
                        </svg>
                        {border.map(borderName => (
                            <svg width={width/2} height={height/2} key={borderName} className={`${borderName} border`}>
                                <polyline stroke={mergedColor[1]} strokeWidth="4" fill=" none" points={`5 ,15  5 ,5  15,5`} />
                            </svg>
                        ))}
