...
var Rbox8 = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("style", null, "\n        .box8 {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            border-radius: 6px;\n        }\n        .slot-content {\n            position: relative;\n            padding: 10px;\n            width: calc(100% - 20px);\n            height: calc(100% - 20px);\n        }\n    \n        .dev-border {\n            position: absolute;\n            display: block;\n        }\n    \n        .border-box-content {\n            position: relative;\n            width: 100%;\n            height: 100%;\n        }\n        .border {\n            position: absolute;\n            display: block;\n          }\n        .right-top {\n            right: 0px;\n            transform: rotateY(180deg);\n          }\n        \n          .left-bottom {\n            bottom: 0px;\n            transform: rotateX(180deg);\n          }\n          .right-bottom {\n            right: 0px;\n            bottom: 0px;\n            transform: rotateX(180deg) rotateY(180deg);\n          }\n        "), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    d: "M15 5 L ".concat(width - 15, " 5 Q ").concat(width - 5, " 5, ").concat(width - 5, " 15 L ").concat(width - 5, " ").concat(height - 15, " Q ").concat(width - 5, " ").concat(height - 5, ", ").concat(width - 15, " ").concat(height - 5, " L 15, ").concat(height - 5, " Q 5 ").concat(height - 5, " 5 ").concat(height - 15, " L 5 15 Q 5 5 15 5")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    strokeWidth: "2",
    fill: "transparent",
    strokeLinecap: "round",
    ...
    filter: "url(#".concat(filterId, ")"),
    stroke: mergedColor[1],
    d: "M ".concat(width - 20, " 5 L ").concat(width - 15, " 5 Q ").concat(width - 5, " 5 ").concat(width - 5, " 15 L ").concat(width - 5, " 20")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    strokeWidth: "2",
    fill: "transparent",
    strokeLinecap: "round",
    filter: "url(#".concat(filterId, ")"),
    stroke: mergedColor[1],
    d: "M ".concat(width - 40, " ").concat(height - 5, " L ").concat(width - 15, " ").concat(height - 5, " Q ").concat(width - 5, " ").concat(height - 5, " ").concat(width - 5, " ").concat(height - 15, " L ").concat(width - 5, " ").concat(height - 40, " ")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    strokeWidth: "2",
    fill: "transparent",
    strokeLinecap: "round",
    filter: "url(#".concat(filterId, ")"),
    stroke: mergedColor[1],
    d: "M 20 ".concat(height - 5, " L 15 ").concat(height - 5, " Q 5 ").concat(height - 5, " 5 ").concat(height - 15, " L 5 ").concat(height - 20)
