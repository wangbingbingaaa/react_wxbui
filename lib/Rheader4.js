...
var Rheader4 = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("style", null, "\n        .progressDash {\n            animation: move 5s linear infinite;\n            stroke-dasharray: 100vw;\n            stroke-dashoffset: 0;\n        \n        }\n        \n        @keyframes move {\n        \n            from {\n                stroke-dashoffset: 100vw;\n            }\n        \n            to {\n                stroke-dashoffset: 0;\n            }\n        \n        }\n        .xbheader4 {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            border-radius: 6px;\n        }\n        .slot-content {\n            position: relative;\n            padding: 10px;\n            width: calc(100% - 20px);\n            height: calc(100% - 20px);\n        }\n    \n        .dev-border {\n            position: absolute;\n            display: block;\n        }\n    \n        .border-box-content {\n            position: relative;\n            width: 100%;\n            height: 100%;\n        }\n        .border {\n            position: absolute;\n            display: block;\n          }\n       \n        "), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    fill: "url(#h4linearGradient_x1_2)",
    points: "0 0 0 ".concat(height / 3, " ").concat(width / 3 - 50, " ").concat(height / 3, " ").concat(width / 3, " ").concat(height - 4, " ").concat(width / 3 * 2, " ").concat(height - 4, " ").concat(width / 3 * 2 + 50, " ").concat(height / 3, " ").concat(width, " ").concat(height / 3, " ").concat(width, " 0")
    ...
    d: "M ".concat(width / 3 - 28, " ").concat(height / 3 * 2, " L ").concat(width / 3 - 4, " ").concat(height - 2, " L ").concat(width / 3 + 8, " ").concat(height - 2)
  }), /*#__PURE__*/_react["default"].createElement("path", {
    stroke: mergedColor[1],
    strokeWidth: "2",
    fill: "none",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M ".concat(width / 3 * 2 + 28, " ").concat(height / 3 * 2, " L ").concat(width / 3 * 2 + 4, " ").concat(height - 2, " L ").concat(width / 3 * 2 - 8, " ").concat(height - 2)
