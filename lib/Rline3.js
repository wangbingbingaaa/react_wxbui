...
var Rline3 = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("style", null, "\n        .line3 {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            border-radius: 6px;\n        }\n        .slot-content {\n            position: relative;\n            padding: 10px;\n            width: calc(100% - 20px);\n            height: calc(100% - 20px);\n        }\n    \n        .dev-border {\n            position: absolute;\n            display: block;\n        }\n    \n        .border-box-content {\n            position: relative;\n            width: 100%;\n            height: 100%;\n        }\n        .border {\n            position: absolute;\n            display: block;\n          }\n        .right-top {\n            right: 0px;\n            transform: rotateY(180deg);\n          }\n        \n          .left-bottom {\n            bottom: 0px;\n            transform: rotateX(180deg);\n          }\n          .right-bottom {\n            right: 0px;\n            bottom: 0px;\n            transform: rotateX(180deg) rotateY(180deg);\n          }\n        "), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    d: "M 0 ".concat(height / 5 * 2, " L ").concat(height / 2, " ").concat(height / 5 * 2)
  }), /*#__PURE__*/_react["default"].createElement("path", {
    stroke: mergedColor[1],
    strokeWidth: "3",
    fill: " none",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M 0 ".concat(height / 5 * 3, " L ").concat(height / 2, " ").concat(height / 5 * 3, " ")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M 16, 0 L ".concat(height / 2 + 16, ",").concat(height / 2, " L 16, ").concat(height, " ")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    stroke: mergedColor[0],
    strokeWidth: "4",
    fill: "none",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M ".concat(width - 16, ", 0 L ").concat(width - height / 2 - 16, ",").concat(height / 2, " L ").concat(width - 16, ",").concat(height, " ")
  }), /*#__PURE__*/_react["default"].createElement("path", {
    stroke: mergedColor[1],
    strokeWidth: "3",
    fill: " none",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M ".concat(width, " ").concat(height / 5 * 2, " L ").concat(width - height / 2, " ").concat(height / 5 * 2)
  }), /*#__PURE__*/_react["default"].createElement("path", {
    stroke: mergedColor[1],
    strokeWidth: "3",
    fill: " none",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    d: "M ".concat(width - height / 2, "  ").concat(height / 5 * 3, " L ").concat(width, " ").concat(height / 5 * 3, " ")
