...
var Rheader2 = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("style", null, "\n       \n        .xbheader2 {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            border-radius: 6px;\n        }\n        .slot-content {\n            position: relative;\n            padding: 10px;\n            width: calc(100% - 20px);\n            height: calc(100% - 20px);\n        }\n    \n        .dev-border {\n            position: absolute;\n            display: block;\n        }\n    \n        .border-box-content {\n            position: relative;\n            width: 100%;\n            height: 100%;\n        }\n        .border {\n            position: absolute;\n            display: block;\n          }\n       \n        "), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    d: "M 0 ".concat(height - 2, " L 20 ").concat(height - 2, " L 25 ").concat(height / 4 * 3, " L 30 ").concat(height - 2, " L 40 ").concat(height - 2, " L 50 ").concat(height / 2, " L 60 ").concat(height - 2, " L ").concat(width / 3, " ").concat(height - 2, " Q ").concat(width / 3 + 20, " ").concat(height - 2, " ").concat(width / 3 + 40, " ").concat(height / 4 * 3, " Q ").concat(width / 3 + 60, " ").concat(height / 2, " ").concat(width / 3 + 80, " ").concat(height / 2, " L ").concat(width, " ").concat(height / 2)
    ...
    points: "".concat(width / 3 + 100, " ").concat(height / 3 * 2, " ").concat(width - 10, " ").concat(height / 3 * 2, " ").concat(width - 10, " ").concat(height - 10, " ").concat(width / 3 + 50, " ").concat(height - 10, " ")
