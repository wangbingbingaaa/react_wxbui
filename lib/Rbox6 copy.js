...
var Rbox6 = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("style", null, "\n        .box6 {\n            position: relative;\n            width: 100%;\n            height: 100%;\n            border-radius: 6px;\n        }\n        .slot-content {\n            position: relative;\n            padding: 10px;\n            width: calc(100% - 20px);\n            height: calc(100% - 20px);\n        }\n    \n        .dev-border {\n            position: absolute;\n            display: block;\n        }\n    \n        .border-box-content {\n            position: relative;\n            width: 100%;\n            height: 100%;\n        }\n        .border {\n            position: absolute;\n            display: block;\n          }\n        .right-top {\n            right: 0px;\n            transform: rotateY(180deg);\n          }\n        \n          .left-bottom {\n            bottom: 0px;\n            transform: rotateX(180deg);\n          }\n          .right-bottom {\n            right: 0px;\n            bottom: 0px;\n            transform: rotateX(180deg) rotateY(180deg);\n          }\n        "), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    strokeWidth: "3",
    points: "0, ".concat(height / 2, " ").concat(width / 14, ",  0 ").concat(width - width / 14, ", 0  ").concat(width, ", ").concat(height / 2, " ").concat(width - width / 14, ",").concat(height, "  ").concat(width / 14, ",").concat(height, "  0, ").concat(height / 2)
  }), /*#__PURE__*/_react["default"].createElement("polyline", {
    stroke: mergedColor[1],
    strokeWidth: "2",
    fill: " none",
    points: "".concat(width / 14 * 3, ", ").concat(height - 6, " ").concat(width / 14 * 11, ",").concat(height - 6)
  }), /*#__PURE__*/_react["default"].createElement("circle", {
    id: "myCircle",
    cx: "".concat(width / 14 * 3 - 10),
    cy: "".concat(height - 6),
    r: "3",
    fill: mergedColor[0]
  }), /*#__PURE__*/_react["default"].createElement("circle", {
    id: "myCircle",
    cx: "".concat(width / 14 * 11 + 10),
    cy: "".concat(height - 6),
    r: "3",
    fill: mergedColor[0]
    ...
    return /*#__PURE__*/_react["default"].createElement("svg", {
      ...
      strokeWidth: "2",
      fill: "none",
      points: "10, ".concat(height / 2, " ").concat(width / 14 + 6, ",  6 ")
    }));
